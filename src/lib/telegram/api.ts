...
export class Telegram {
    ...
    private formMessageMarkdown(chat: telegram.Chat, response: telegram.CommonResponse) {
        let param: {
            chat_id: number,
            text: string,
            parse_mode: string,
    ...
    private formMessageMarkdownWithId(message: telegram.Message, response: telegram.CommonResponse) {
        let param: {
            chat_id: number,
            message_id: number,
            text: string,
